...
/*
 * Mainly copied on AndroidX's version
 */
...
public class SeekBarPreference extends Preference {
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
            boolean mAdjustable; // whether the seekbar should respond to the left/right keys
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        if (mSeekBarValueTextView != null) {
            mSeekBarValueTextView.setText(String.format(mFormat, mSeekBarValue));
        }
     ...
     * Update TextView
     */
    void syncTextview(int seekBarValue) {
        if (seekBarValue < mMin) {
            seekBarValue = mMin;
        }
        if (seekBarValue > mMax) {
        ...
        if (mSeekBarValueTextView != null) {
            mSeekBarValueTextView.setText(String.format(mFormat, seekBarValue));
        }
    }
